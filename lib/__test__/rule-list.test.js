...
describe('rules', () => {
    ...
    suite('common denominators', rules.COMMON_DENOMINATOR, [
        ...
        // Repeated variable denominators won't match
        //['2/(3 + x) + 4/(3 + x)'],
        // Repeated numeric denominators won't match
        //['2/4 + 5/4'],
        ['2/6 - 1/4', '(2 * 2) / (6 * 2) - (1 * 3) / (4 * 3)'],
        ...
        ['3 + 2/3', '(3 * 3) / (1 * 3) + (2 * 1) / (3 * 1)'],
        ['x + 2 + 3/4', '(x * 4) / (1 * 4) + (2 * 4) / (1 * 4) + (3 * 1) / (4 * 1)'],
        ['(x + 1)^2 + 2/3', '((x + 1)^2 * 3) / (1 * 3) + (2 * 1) / (3 * 1)'],
        ['2(x + 1)^2 + 2/3', '(2 (x + 1)^2 * 3) / (1 * 3) + (2 * 1) / (3 * 1)'],
    ])
