...
export const isOperation = node => node && node.type === 'Apply' && !isNumber(node)

export const isAdd = node => node && node.type === 'Apply' && node.op === 'add'
export const isMul = node => node && node.type === 'Apply' && node.op === 'mul'
export const isPow = node => node && node.type === 'Apply' && node.op === 'pow'
