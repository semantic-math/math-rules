...
import {defineRule} from './matcher'
import {isNumber, isOperation, isMul, numberNode} from './nodes'
...
export const SIMPLIFY_ARITHMETIC = defineRule(
    node => isOperation(node) && node.args.every(isNumber),
...
export const COLLECT_CONSTANT_EXPONENTS = defineRuleString(
