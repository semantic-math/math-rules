...
export const FACTOR_SUM_PRODUCT_RULE = defineRule(
    ...
    (node) => {
        ...
        const secondCoef = query.getValue(secondTerm.args[0])
        ...
        const thirdFactors = getFactors(thirdCoef)
        let combo
        ...
        for (var i in firstFactors){
            for (var j in thirdFactors) {
                ...
                if (l1[0] * l2[1] + l1[1] * l2[0] == secondCoef
                    || l1[1] * l2[1] + l1[0] * l2[0] == secondCoef){
                    combo = [l1,l2]
                }
            }
        }
