...
describe('applyRules', () => {
    ...
    it('multiply by zero reverse', () => {
        assert.equal(applyRuleString(rules.MULTIPLY_BY_ZERO_REVERSE, '0 * 2'), '0');
    });
    ...
    it('remove adding zero reverse', () => {
        assert.equal(applyRuleString(rules.REMOVE_ADDING_ZERO_REVERSE, '0 + 2'), '2');
    });
    ...
    it('remove multiplying by one reverse', () => {
        assert.equal(applyRuleString(rules.REMOVE_MULTIPLYING_BY_ONE_REVERSE, '1 * 2'), '2');
    });
    ...
    it.skip('multiply fractions', () => {
        assert.equal(applyRuleString(rules.MULTIPLY_FRACTIONS, '3 / 2 * 2 / 3'), '(3 * 2) / (2 * 3)');
    });
